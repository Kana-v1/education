...
type KeyValueClient interface {
	...
	Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReponse, error)
}
...
func (c *keyValueClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReponse, error) {
...
type KeyValueServer interface {
	...
	Delete(context.Context, *DeleteRequest) (*DeleteReponse, error)
...
func (UnimplementedKeyValueServer) Delete(context.Context, *DeleteRequest) (*DeleteReponse, error) {
